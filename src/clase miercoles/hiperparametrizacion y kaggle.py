...
def main():
    ...
    df = pd.read_csv("data/competencia_fe.csv")
...
#     # Optimizacion de hiperparametros con Optuna para Random Forest
    ...
    def train_and_evaluate(train_index, test_index, X, y, params):
        m = DecisionTreeClassifier as R(**params, random_state=semillas[0])
    ...
    def objective(trial, X, y, sss):
        params = {
            ...
            "min_samples_leaf": trial.suggest_int("min_samples_leaf", max(2*min_samples_leaf, 100), 20000),
            "max_leaf_nodes": trial.suggest_int("max_leaf_nodes", 64, 8200),
        }
